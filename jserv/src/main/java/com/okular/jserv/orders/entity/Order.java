...
import static com.okular.jserv.orders.entity.Order.FIND_ALL;
import static com.okular.jserv.orders.entity.Order.FIND_UNFINISHED;

@Entity
@Table(name = "orders")
@NamedQueries({
        @NamedQuery(name = FIND_UNFINISHED, query = "select o from Order o where o.status <> com.okular.jserv.orders.entity.OrderStatus.COLLECTED"),
